...
public sealed class UserGetInfoFunction
{
    private readonly JwtTokenService _jwt;

    public UserGetInfoFunction(JwtTokenService jwt)
    {
        _jwt = jwt;
    }
    ...
    public async Task<HttpResponseData> Run(
        [HttpTrigger(AuthorizationLevel.Anonymous, "get", "options", Route = "user/me")]
        HttpRequestData req)
    {
        ...
        // 1. access token を Cookie から取り出す
        ...
        // 2. JWT を検証して userId と userName を取得
